...
/// <summary>
/// Benchmarks <see cref="IRacingRelativeCalculator.Compute"/> вЂ” the data-path
/// computation that runs at ~10 Hz whenever iRacing is in session.
///
/// Targets:
///   Mean (40 cars) &lt; 50 Вµs  (budget: 100 Вµs per tick, 50% headroom)
///   Alloc           measured  (not zero вЂ” builds Dictionary + List; acceptable at 10 Hz)
/// </summary>
[MemoryDiagnoser]
