...
public enum ProviderState
{
    ...
    /// <c>true</c>) but is not yet the active data source вЂ” either another provider is
    ...
    /// threshold is reached вЂ” even if another sim starts in the meantime.
    /// </summary>
    Active,
    ...
    /// results в†’ transitions to <see cref="Idle"/>.
    /// </summary>
    Disconnecting,
}
