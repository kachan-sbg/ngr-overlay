...
/// Range will be exposed in user config (suggested: 0.05вЂ“0.40).
/// </summary>
public static class EmaConstants
{
    /// <summary>Smoothing factor for gap-to-player and gap-to-leader values (0вЂ“1).</summary>
    public const float GapAlpha      = 0.15f;
    /// <summary>Smoothing factor for interval-to-car-ahead values (0вЂ“1).</summary>
    public const float IntervalAlpha = 0.15f;
}

/// <summary>
/// Exponential moving average filter: smoothedValue = О±В·new + (1в€’О±)В·prev.
/// Zero-allocation struct вЂ” safe to embed in per-car arrays.
