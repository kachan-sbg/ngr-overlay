...
public sealed class FuelCalculatorOverlay : BaseOverlay
{
    ...
    public const string WindowTitle = "SimOverlay \u2014 Fuel";
    ...
    protected override void OnRender(ID2D1RenderTarget ctx, OverlayConfig cfg)
    {
        ...
        var   boldFmt     = Resources.GetTextFormat("Consolas", fontSize + 1f);
        var   headerFmt   = Resources.GetTextFormat("Consolas", fontSize - 1f);
