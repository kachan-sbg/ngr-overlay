...
namespace NrgOverlay.Sim.LMU.SharedMemory;
...
internal static class LmuSharedMemoryLayout
{
    ...
    //   AFTER the pack pop в†’ SharedMemoryScoringData uses default (8-byte) packing on x64.
    //   ScoringInfoV01 was defined under pack(4), so its alignof = 4, sizeof = 548.
    //   Next member: size_t scoringStreamSize (alignof = 8).
    //   548 % 8 = 4 в†’ 4 bytes of implicit padding inserted before size_t.
    ...
    //   ScoringInfoV01(548) + padding(4) + size_t(8) + VehicleScoringInfoV01Г—104(60736) + scoringStream(65536) = 126832 bytes.
    ...
    // (TelemInfoV01 was defined under pack4 в†’ alignof=4; 3%4=3 в†’ 1 byte pad) = 4 bytes before telemInfo[].
...
// в”Ђв”Ђ Shared vector type в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ

/// <summary>3D vector used in multiple LMU structs (3 Г— double = 24 bytes).</summary>
...
// в”Ђв”Ђ Session-level scoring info в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
...
internal struct LmuScoringInfo
{
    ...
    public double EndET;               // [76]   8 B   session end time; в‰¤0 means laps-based
    ...
    public double Raining;             // [220]  8 B   precipitation intensity 0вЂ“1
    public double AmbientTempC;        // [228]  8 B   ambient air temperature (В°C)
    public double TrackTempC;          // [236]  8 B   track surface temperature (В°C)
    public LmuVect3 Wind;              // [244] 24 B   wind vector; magnitude = wind speed m/s
    public double MinPathWetness;      // [268]  8 B   minimum track wetness 0вЂ“1
    public double MaxPathWetness;      // [276]  8 B   maximum track wetness 0вЂ“1
    ...
    /// <summary>
    /// Wind direction in degrees (0вЂ“360), measured clockwise from north (+Z axis).
...
// в”Ђв”Ђ Per-vehicle scoring в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
...
// в”Ђв”Ђ Snapshot record в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
