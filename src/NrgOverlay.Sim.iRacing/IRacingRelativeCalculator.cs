...
/// No SDK dependency вЂ” fully unit-testable.
///
/// <para>
/// <b>Session modes</b>:
/// <list type="bullet">
...
internal sealed class IRacingRelativeCalculator
{
    ...
    // Per-car EMA filters вЂ” indexed by CarIdx.
        ...
        CarStateTracker              carState)
    {
        ...
        // Build O(1) lookup: CarIdx в†’ DriverSnapshot
        var driverByIdx = new Dictionary<int, DriverSnapshot>(drivers.Count);
        foreach (var d in drivers)
            driverByIdx[d.CarIdx] = d;

        // в”Ђв”Ђ Determine whether the player is spawned on track в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
        ...
        // в”Ђв”Ђ Pass 1: collect candidates for the relative board в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
        // On-track cars (surface в‰Ґ 0, pct в‰Ґ 0) get a real gap.
        // Registered session drivers who are in the garage (irsdk_NotInWorld) get a
        // sentinel gap so they still appear at the bottom of the relative вЂ” the user
        ...
        for (int i = 0; i < snapshot.LapDistPcts.Length; i++)
        {
            ...
            {
                // Player in garage вЂ” on-track cars appear "ahead" sorted by pct descending.
                gap = -(pct * estLapTime);
            }
        ...
        // в”Ђв”Ђ Real-time positions (race mode only) в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
        ...
        // в”Ђв”Ђ Per-class positions (relative board) в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
        ...
        // в”Ђв”Ђ Build relative candidates (on-track only, sorted by smoothed gap) в”Ђ
        ...
        foreach (var car in onTrackCars)
        {
            ...
            // Smooth gap вЂ” skip EMA for garage sentinel values so filter state stays clean.
        ...
        // в”Ђв”Ђ Standings: include ALL registered session drivers в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
        ...
        CarStateTracker                                    carState)
    {
        ...
        // в”Ђв”Ђ Sort в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
        // Race:     on-track by rt position в†’ on-track by lap progress в†’ garage by best lap
        ...
        // в”Ђв”Ђ Compute per-class positions for all session drivers в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
        ...
        for (int rank = 0; rank < sorted.Count; rank++)
        {
            ...
            // в”Ђв”Ђ Gap to leader в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђ
